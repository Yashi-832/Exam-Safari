...
<<<<<<< HEAD
  ...
  <div className="mx-6 py-10 text-center md:text-left">
     <div className="footer-container">
      ...
      <div className='flex-sub-section'>
        <div className="footer-section">
          <h6
            className="mb-4 flex items-center  font-semibold uppercase  md:justify-start heading">
            <svg
        ...
        <div className="footer-section">
          <h6
            className="mb-4 flex font-semibold uppercase md:justify-start heading">
            Products
          </h6>
          <p className="mb-4">
    ...
    <div className='seperate'>
      <div className='flex'>
        ...
        <a href='#!'>
          <img src='https://res.cloudinary.com/dkredoejm/image/upload/v1705668898/appstore_ukrwoe.png' className='image'/>
        </a>
      </div>
      <div>
          <h6
            className="mb-4 mt-16 flex font-semibold heading">
            Follow us on
          </h6>
          <div className="flex">
          ...
          <div className="flex">
            ...
            <a href="#!" className="mr-6 text-neutral-600 dark:text-neutral-200 logo-color-insta">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="#f52f77"
            ...
            <a href="#!" className="text-neutral-600 logo-color-git">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="white"
  ...
  <hr/>
  <div className="p-6 text-center" style={{fontWeight:"bold"}}>
=======
